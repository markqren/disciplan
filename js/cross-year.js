...
async function renderCrossYear(el){
  ...
  try{
    ...
    ]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{labels:{color:"rgba(255,255,255,0.6)",font:{size:11},usePointStyle:true,pointStyleWidth:16}},tooltip:{callbacks:{label:ctx=>{const d=ctx.dataset.label;if(d==="Savings Rate")return d+": "+(ctx.parsed.y==null?"\u2014":Math.round(ctx.parsed.y)+"%");if(d==="Expenses"){const r=ctx.raw;return d+": "+fmtT(Array.isArray(r)?r[1]-r[0]:r);}return d+": "+fmtT(ctx.parsed.y);}}}},scales:{x:{ticks:{color:"rgba(255,255,255,0.4)"},grid:{display:false}},y:{ticks:{color:"rgba(255,255,255,0.4)",callback:v=>fmtN(v)},grid:{color:"rgba(255,255,255,0.04)"}},y1:{position:"right",min:0,max:100,ticks:{color:"rgba(242,204,143,0.6)",callback:v=>String(v).padStart(3)+"%",font:{size:10,family:"'JetBrains Mono',monospace"}},grid:{display:false}}}}}),50);
